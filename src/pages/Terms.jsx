            ...
            <div className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h1 className="text-4xl font-light text-black">Terms of Service</h1>
                    </div>
                ...
                <div className="space-y-8 text-[#0F1729]">
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">1. Acceptance of Terms</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">2. Description of Service</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">3. User Responsibilities</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">4. Subscription and Payments</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">5. Intellectual Property Rights</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">6. User Content and Data Ownership</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">7. Service Availability</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">8. Limitation of Liability</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">9. Termination</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">10. Changes to Terms</h2>
                        <p>We may update these terms from time to time. Continued use of the service after changes constitutes acceptance of the new terms.</p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-light text-[#2E5C8A] mb-4">11. Governing Law and Jurisdiction</h2>
