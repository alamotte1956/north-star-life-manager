        ...
        <div className="min-h-screen bg-gradient-to-br from-black via-[#0a0a0a] to-black">
            <div className="max-w-4xl mx-auto px-6 py-12">
                ...
                <div className="space-y-8 text-[#F4E4C1]">
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#C5A059] mb-4">5. Data Ownership</h2>
                        <p>You retain all rights to the content you upload. We store and process your data solely to provide the service. You can export or delete your data at any time.</p>
                    </section>

                    <section>
                        <h2 className="text-2xl font-light text-[#C5A059] mb-4">6. Service Availability</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#C5A059] mb-4">7. Limitation of Liability</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#C5A059] mb-4">8. Termination</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-light text-[#C5A059] mb-4">9. Changes to Terms</h2>
