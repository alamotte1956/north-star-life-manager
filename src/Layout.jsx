...
export default function Layout({ children, currentPageName }) {
    ...
    const navItems = [
        ...
        { name: 'Security Audit', icon: Shield, path: 'SecurityAudit' },
                ...
                <div className="p-6 border-b border-[#2E5C8A]/20">
                    <Link to={createPageUrl('Home')} className="flex items-center gap-3 mb-4 hover:opacity-80 transition-opacity">
                        ...
                        <div>
                            ...
                            <p className="text-[#B8D4ED]/70 text-[10px] font-light italic mt-1">Health, Wealth, Legacy — Aligned</p>
                        </div>
                    </Link>
                    <Link
                ...
                <div className="flex items-center justify-between px-4 h-16">
                    <Link to={createPageUrl('Home')} className="flex items-center gap-3 hover:opacity-80 transition-opacity">
                        ...
                        <div>
                            ...
                            <p className="text-[#B8D4ED]/70 text-[9px] font-light italic">Health, Wealth, Legacy — Aligned</p>
                        </div>
                        </Link>
